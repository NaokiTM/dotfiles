# Dotfiles
- I use linux mint, i3 gaps, polybar, rofi, neovim, alacritty or kitty, fastfetch
- I haven't learned how to properly version control my linux files so just copy and pasting updates into the files atm. probably won't bother to do it properly since i'm just looking for a way to store my dotfiles not necessarily keep on top of them
